...
def main():
    ...
    num_repeats = 33  # Modify this value to change the number of repetitions
    ...
    for current_system in systems:
        datasets_location = 'D:/ISE_lab2/lab2/datasets/{}'.format(current_system) # Modify this to specify the location of the datasets
